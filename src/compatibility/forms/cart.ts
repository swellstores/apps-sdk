async function getShopifyCompatibleServerParams(
  formType: string,
  context: any,
) {
...
async function getShopifyCompatibleServerResponse(
  formType: string,
  context: any,
  response: any,
) {
...
export async function cartAdd({ params, swell, theme }: any) {
...
export async function cartUpdate(context: any) {
...
export async function cartCheckout(context: any) {
